...
public class Java_OTP {
    ...
    // Function to Generate One Time Password(OTP)
    ...
    public static void main(String[] args) {
        ...
        while(run_program) {
            ...
            if (choice == 1) {
                ...
                // Taking input for receiver's mail address 
                ...
                // Taking input from user for OTP
                String user_otp;
